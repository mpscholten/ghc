...
instances. We call them "method helpers".  For example, in GHC.Internal.Float:
...
Similarly with the overloaded `boundedEnumFrom` functions. E.g. in GHC.Internal.Word
...
{-# INLINE [0] eftCharFB #-} -- See Note [Inline FB functions] in GHC.Internal.List
...
{-# INLINE [0] efdCharFB #-} -- See Note [Inline FB functions] in GHC.Internal.List
...
{-# INLINE [0] efdtCharFB #-} -- See Note [Inline FB functions] in GHC.Internal.List
...
{-# INLINE [0] efdtIntFB #-} -- See Note [Inline FB functions] in GHC.Internal.List
...
-- Requires x2 >= x1
{-# INLINE [0] efdtIntUpFB #-} -- See Note [Inline FB functions] in GHC.Internal.List
...
-- Requires x2 <= x1
{-# INLINE [0] efdtIntDnFB #-} -- See Note [Inline FB functions] in GHC.Internal.List
...
{-# INLINE [0] eftWordFB #-} -- See Note [Inline FB functions] in GHC.Internal.List
...
{-# INLINE [0] efdtWordFB #-} -- See Note [Inline FB functions] in GHC.Internal.List
...
-- Requires x2 >= x1
{-# INLINE [0] efdtWordUpFB #-} -- See Note [Inline FB functions] in GHC.Internal.List
...
-- Requires x2 <= x1
{-# INLINE [0] efdtWordDnFB #-} -- See Note [Inline FB functions] in GHC.Internal.List
